...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "UserWidget\0chooseBackSignal\0"
};
...
void UserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::chooseBackSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UserWidget::chooseBackSignal()
{
